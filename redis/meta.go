...
func (md *metadata) encode() []byte {
	...
	index += binary.PutVarint(buf[index:], int64(size))
	if md.dataType == List {
...
type hashInteralKey struct {
	key     []byte
	version int64
	field   []byte
}

func (hk *hashInteralKey) encode() []byte {
...
type setInteralKey struct {
	key     []byte
	version int64
	member  []byte
}

func (sk *setInteralKey) encode() []byte {
...
type listInteralKey struct {
	key     []byte
	version int64
	index   uint64
}

func (lk *listInteralKey) encode() []byte {
...
func (zk *zsetInteralKey) encodeWithMember() []byte {
...
func (zk *zsetInteralKey) encodeWithScore() []byte {
