...
func newWrongNumberOfArgError(cmd string) error {
	return fmt.Errorf("ERR wrong number of arguemnts for '%s' command", cmd)
}
...
func set(cli *BitcaskClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
		return nil, newWrongNumberOfArgError("set")
	}
	//set a 100
...
func get(cli *BitcaskClient, args [][]byte) (interface{}, error) {
	if len(args) != 1 {
		return nil, newWrongNumberOfArgError("get")
	}
	//set a 100
...
func hset(cli *BitcaskClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
		return nil, newWrongNumberOfArgError("hset")
	}
	var ok = 0
...
func sadd(cli *BitcaskClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
		return nil, newWrongNumberOfArgError("sadd")
	}
	var ok = 0
...
func lpush(cli *BitcaskClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
		return nil, newWrongNumberOfArgError("lpush")
	}
	key, value := args[0], args[1]
...
func zadd(cli *BitcaskClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
		return nil, newWrongNumberOfArgError("zadd")
	}
	var ok = 0
